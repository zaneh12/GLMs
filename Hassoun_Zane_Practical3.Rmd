...
Answer: a) or b) compare with erik 
...
Answer: c) This is false because there is no proper distrubtion so LRT doesnt actually exist
...
Answer: b) I think by deduction but idk 
```{r}
par(mfrow =c(1,2))
set.seed(5)
